...
///
void* imageflow_job_get_io(void* context, void* job, int32_t placeholder_id);
...
bool imageflow_job_add_io(void* context, void* job, void* io, int32_t placeholder_id, Direction direction);
