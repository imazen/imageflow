...
static int32_t flow_node_create_codec_on_buffer(Context* c, struct flow_job* job, struct flow_graph** graph_ref,
...
static int32_t create_node_for_buffer(Context* c, struct flow_job* job, struct flow_job_resource_item* item,
                                      struct flow_graph** g)
{
...
static int32_t create_node_for_resource(Context* c, struct flow_job* job, struct flow_job_resource_item* item,
                                        struct flow_graph** g)
{
