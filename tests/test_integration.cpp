...
uint8_t gif_bytes_32[] = {0x47, 0x49, 0x46, 0x38, 0x39, 0x61, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x21, 0xF9, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2C, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x02};
uint8_t gif_bytes_43[] = {0x47,0x49,0x46,0x38,0x39,0x61,0x01,0x00,0x01,0x00,0x80,0x00,0x00,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x21,0xF9,0x04,0x00,0x00,0x00,0x00,0x00,0x2C,0x00,0x00,0x00,0x00,0x01,0x00,0x01,0x00,0x00,0x02,0x02,0x44,0x01,0x00,0x3B};
static int read_func(GifFileType* gif, GifByteType* buffer, int bytes_please)
{
    ...
    if (*cursor + bytes_please > gif_byte_count){
        fprintf(stderr, "More bytes requested (%i) by giflib than available (%i)", bytes_please, gif_byte_count - *cursor);
