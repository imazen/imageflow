...
#include "../imageflow.h"
  ...
  flow_status_Invalid_BitmapBgra_dimensions = 1
  flow_status_Invalid_BitmapFloat_dimensions = 1
  flow_status_Unsupported_pixel_format = 1
  flow_status_Invalid_internal_state = 1
  flow_status_Transpose_not_permitted_in_place = 1
  flow_status_Invalid_interpolation_filter = 1
  flow_status_Invalid_argument = 1
  flow_status_Null_argument = 1
  flow_status_Interpolation_details_missing = 1
  flow_status_Node_already_deleted = 1
  flow_status_Edge_already_deleted = 1
  flow_status_Graph_could_not_be_completed = 1
  flow_status_Not_implemented = 1
  flow_status_Invalid_inputs_to_node = 1
  flow_status_Graph_not_flattened = 1
  flow_status_Failed_to_open_file = 1
  flow_status_Graph_could_not_be_executed = 1
  flow_status_Png_decoding_failed = 1
  flow_status_Png_encoding_failed = 1
  flow_status_Jpeg_decoding_failed = 1
  flow_status_Jpeg_encoding_failed = 1
