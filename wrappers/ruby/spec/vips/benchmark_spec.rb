...
module Imageflow::Vips
  ...
  describe 'imageflow-vips' do
    it 'should be of similar speed' do
      ...
      ["gamma_dalai_lama_gray.jpg", "u1.jpg", "mountain_800.jpg"].each do |input_file_basename|

        input_file = "#{dir}/#{input_file_basename}"
        url = "https://s3-us-west-2.amazonaws.com/imageflow-resources/test_inputs/#{input_file_basename}"
