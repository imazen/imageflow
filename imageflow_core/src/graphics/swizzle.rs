...
pub(crate) fn swap_br_inplace(row: &mut [u8]) {
    debug_assert!(row.len().is_multiple_of(4), "BGRA row length must be a multiple of 4");
...
pub(crate) fn copy_swap_br(src: &[u8], dst: &mut [u8]) {
    debug_assert!(src.len().is_multiple_of(4), "src length must be a multiple of 4");
...
pub(crate) fn rgb_to_bgra(src: &[u8], dst: &mut [u8]) {
    debug_assert!(src.len().is_multiple_of(3), "RGB src length must be a multiple of 3");
...
pub(crate) fn gray_alpha_to_bgra(src: &[u8], dst: &mut [u8]) {
    debug_assert!(src.len().is_multiple_of(2), "gray-alpha src length must be a multiple of 2");
